...
- If the target cluster is wider than the whole text area, show its start cell at offset `T` (start-cell rule wins; the remainder is clipped to blanks).
